...
require('packer').startup(function()
  ...
  use 'ishan9299/nvim-solarized-lua' -- Theme solarized dark
  ...
  use 'jose-elias-alvarez/null-ls.nvim' -- Use null-ls for bash stuff
...
-- Show next search match at the center of the screen
